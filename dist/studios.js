...
function setupStudiosInstance(fsListInstance) {
    ...
    if (locateButtonEl) locateButtonEl.addEventListener("click", async ()=>{
    ...
    if (searchAreaButtonEl) searchAreaButtonEl.addEventListener("click", ()=>{
        if (!isLoaded) return;
...
window.FinsweetAttributes.push([
    ...
    (listInstances)=>{
        ...
        if (!window.mapboxgl) {
            console.warn("[studios-map] mapbox-gl not found on window. Add the CDN script to the Webflow <head>.");
            return;
        }
...
},{"./location.js":"WOwQU"}],"WOwQU":[function(require,module,exports,__globalThis) {
/**
 * Location
 *
...
},{}]},["ctcwF","efEHR"], "efEHR", "parcelRequire08d4", {})
