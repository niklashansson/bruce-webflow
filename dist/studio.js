...
})({"6GBrA":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "49e963ef8a14ef86";
"use strict";
...
},{}],"a0doV":[function(require,module,exports,__globalThis) {
...
function readCoords(component) {
    ...
    if (isNaN(lat) || isNaN(lng)) {
        console.warn(`[studio-map] Non-numeric lat/lng ("${latEl.textContent}", "${lngEl.textContent}")`);
        return null;
    }
    return [
        lng,
...
function initMap(component, mapTarget, coords) {
    (0, _mapboxJs.loadMapboxGl)().then((mapboxgl)=>{
        ...
        const marker = markerEl ? new mapboxgl.Marker({
            element: markerEl,
            anchor: "center"
        }) : new mapboxgl.Marker();
...
function setupStudioMap(component, mapTarget, coords) {
    const observer = new IntersectionObserver((entries)=>{
        ...
        observer.disconnect();
        (0, _mapboxJs.whenIdle)(()=>initMap(component, mapTarget, coords));
    }, {
        rootMargin: "200px"
    });
...
},{"./mapbox.js":"enNxR"}],"enNxR":[function(require,module,exports,__globalThis) {
...
},{}]},["6GBrA","a0doV"], "a0doV", "parcelRequire08d4", {})
